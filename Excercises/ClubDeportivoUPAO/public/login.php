                                            ...
                                            <ul class="nav-menu text-right">
                                                ...
                                                <li class="current-menu-item current_page_item menu-item-has-children"><a href="#">Pages</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active last-item"><a href="my-account.html">My account</a></li>
                                                    </ul>
                                                </li>
                                                <!-- Pages Menu End -->
                ...
                <div class="breadcrumbs-inner">
                    <div class="container">
                        <div class="breadcrumbs-text">
                            <h1 class="breadcrumbs-title mb-17">My account</h1>
                ...
                <div class="row pb-100 md-pb-72">
                    <div class="col-lg-7 md-mb-70">
                        <div class="regi-side">
                            ...
                            <form class="register-form" id="register-form" method="post" action="http://rstheme.com/products/html/khelo/mailer.php">
