    ...
    <body>
                                    ...
                                    <div class="main-menu">
                                        ...
                                        <nav class="rs-menu">
                                            ...
                                            <ul class="nav-menu text-right">
                                                ...
                                                <!--Point Table Start-->
                                                <li class="current-menu-item"><a href="point-table.html">Point Table</a></li>
                                                <!--Point Table End-->
        ...
        <div class="rs-breadcrumbs">
            <div class="breadcrumbs-wrap">
                <img src="images/breadcrumbs/inner3.jpg" alt="Breadcrumbs Image">
                <div class="breadcrumbs-inner">
                    <div class="container">
                        <div class="breadcrumbs-text">
                            <h1 class="breadcrumbs-title mb-17">Point Table</h1>
                            <div class="categories">
                                <ul>
                                    <li><a href="index-2.html">Home</a></li>
                                    <li class="active">Point Table</li>
                                </ul>
                            </div>
                        </div>
                    </div>
